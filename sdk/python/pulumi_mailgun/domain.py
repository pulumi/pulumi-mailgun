...
class DomainArgs:
    def __init__(__self__, *,
                 click_tracking: Optional[pulumi.Input[builtins.bool]] = None,
                 dkim_key_size: Optional[pulumi.Input[builtins.int]] = None,
                 dkim_selector: Optional[pulumi.Input[builtins.str]] = None,
                 force_dkim_authority: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 open_tracking: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 smtp_password: Optional[pulumi.Input[builtins.str]] = None,
                 spam_action: Optional[pulumi.Input[builtins.str]] = None,
                 web_scheme: Optional[pulumi.Input[builtins.str]] = None,
                 wildcard: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Domain resource.
        :param pulumi.Input[builtins.bool] click_tracking: (Enum: `yes` or `no`) The click tracking settings for the domain. Default: `no`
        :param pulumi.Input[builtins.int] dkim_key_size: The length of your domain’s generated DKIM key. Default value is `1024`.
        :param pulumi.Input[builtins.str] dkim_selector: The name of your DKIM selector if you want to specify it whereas MailGun will make it's own choice.
        :param pulumi.Input[builtins.bool] force_dkim_authority: If set to true, the domain will be the DKIM authority for itself even if the root domain is registered on the same mailgun account. If set to false, the domain will have the same DKIM authority as the root domain registered on the same mailgun account. The default is `false`.
        :param pulumi.Input[builtins.str] name: The domain to add to Mailgun
        :param pulumi.Input[builtins.bool] open_tracking: (Enum: `yes` or `no`) The open tracking settings for the domain. Default: `no`
        :param pulumi.Input[builtins.str] region: The region where domain will be created. Default value is `us`.
        :param pulumi.Input[builtins.str] smtp_password: Password for SMTP authentication
        :param pulumi.Input[builtins.str] spam_action: `disabled` or `tag` Disable, no spam
               filtering will occur for inbound messages. Tag, messages
               will be tagged with a spam header. Default value is `disabled`.
        :param pulumi.Input[builtins.str] web_scheme: (`http` or `https`) The tracking web scheme. Default: `http`
        :param pulumi.Input[builtins.bool] wildcard: Boolean that determines whether
    ...
    def click_tracking(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def click_tracking(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "click_tracking", value)

    @property
    @pulumi.getter(name="dkimKeySize")
    def dkim_key_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def dkim_key_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "dkim_key_size", value)

    @property
    @pulumi.getter(name="dkimSelector")
    def dkim_selector(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dkim_selector(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dkim_selector", value)

    @property
    @pulumi.getter(name="forceDkimAuthority")
    def force_dkim_authority(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If set to true, the domain will be the DKIM authority for itself even if the root domain is registered on the same mailgun account. If set to false, the domain will have the same DKIM authority as the root domain registered on the same mailgun account. The default is `false`.
        """
    ...
    def force_dkim_authority(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def open_tracking(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def open_tracking(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def smtp_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def smtp_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "smtp_password", value)

    @property
    @pulumi.getter(name="spamAction")
    def spam_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @spam_action.setter
    def spam_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spam_action", value)

    @property
    @pulumi.getter(name="webScheme")
    def web_scheme(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @web_scheme.setter
    def web_scheme(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DomainState:
    def __init__(__self__, *,
                 ...
                 smtp_login: Optional[pulumi.Input[builtins.str]] = None,
                 smtp_password: Optional[pulumi.Input[builtins.str]] = None,
                 spam_action: Optional[pulumi.Input[builtins.str]] = None,
                 web_scheme: Optional[pulumi.Input[builtins.str]] = None,
                 wildcard: Optional[pulumi.Input[builtins.bool]] = None):
        ...
        :param pulumi.Input[builtins.str] smtp_login: The login email for the SMTP server.
        :param pulumi.Input[builtins.str] smtp_password: Password for SMTP authentication
        :param pulumi.Input[builtins.str] spam_action: `disabled` or `tag` Disable, no spam
               filtering will occur for inbound messages. Tag, messages
               will be tagged with a spam header. Default value is `disabled`.
    ...
    def smtp_login(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @smtp_login.setter
    def smtp_login(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Domain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            spam_action: Optional[pulumi.Input[builtins.str]] = None,
            web_scheme: Optional[pulumi.Input[builtins.str]] = None,
            wildcard: Optional[pulumi.Input[builtins.bool]] = None) -> 'Domain':
        """
    ...
    @property
    @pulumi.getter(name="clickTracking")
    def click_tracking(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Enum: `yes` or `no`) The click tracking settings for the domain. Default: `no`
        """
        return pulumi.get(self, "click_tracking")
    ...
    @property
    @pulumi.getter(name="dkimKeySize")
    def dkim_key_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The length of your domain’s generated DKIM key. Default value is `1024`.
        """
        return pulumi.get(self, "dkim_key_size")
    ...
    @property
    @pulumi.getter(name="dkimSelector")
    def dkim_selector(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of your DKIM selector if you want to specify it whereas MailGun will make it's own choice.
        """
        return pulumi.get(self, "dkim_selector")
    ...
    @property
    @pulumi.getter(name="forceDkimAuthority")
    def force_dkim_authority(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to true, the domain will be the DKIM authority for itself even if the root domain is registered on the same mailgun account. If set to false, the domain will have the same DKIM authority as the root domain registered on the same mailgun account. The default is `false`.
        """
        return pulumi.get(self, "force_dkim_authority")
    ...
    @property
    @pulumi.getter(name="openTracking")
    def open_tracking(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Enum: `yes` or `no`) The open tracking settings for the domain. Default: `no`
        """
        return pulumi.get(self, "open_tracking")
    ...
    @property
    @pulumi.getter(name="smtpLogin")
    def smtp_login(self) -> pulumi.Output[builtins.str]:
        """
        The login email for the SMTP server.
        """
        return pulumi.get(self, "smtp_login")
    ...
    @property
    @pulumi.getter(name="smtpPassword")
    def smtp_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Password for SMTP authentication
        """
        return pulumi.get(self, "smtp_password")
    ...
    @property
    @pulumi.getter(name="spamAction")
    def spam_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        `disabled` or `tag` Disable, no spam
        filtering will occur for inbound messages. Tag, messages
        will be tagged with a spam header. Default value is `disabled`.
    ...
    @property
    @pulumi.getter(name="webScheme")
    def web_scheme(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (`http` or `https`) The tracking web scheme. Default: `http`
        """
        return pulumi.get(self, "web_scheme")
    ...
    @property
    @pulumi.getter
    def wildcard(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean that determines whether
        the domain will accept email for sub-domains.
        """
