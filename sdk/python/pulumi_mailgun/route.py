...
class RouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] expression: A filter expression like `match_recipient('.*@gmail.com')`
        :param pulumi.Input[builtins.int] priority: Smaller number indicates higher priority. Higher priority routes are handled first.
...
class Route(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expression: Optional[pulumi.Input[builtins.str]] = None,
            priority: Optional[pulumi.Input[builtins.int]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'Route':
        """
