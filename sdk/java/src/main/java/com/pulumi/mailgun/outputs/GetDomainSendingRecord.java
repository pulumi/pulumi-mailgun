...
public final class GetDomainSendingRecord {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDomainSendingRecord", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDomainSendingRecord", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder recordType(String recordType) {
            if (recordType == null) {
              throw new MissingRequiredPropertyException("GetDomainSendingRecord", "recordType");
            }
        ...
        public Builder valid(String valid) {
            if (valid == null) {
              throw new MissingRequiredPropertyException("GetDomainSendingRecord", "valid");
            }
            this.valid = valid;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainSendingRecord", "value");
            }
            this.value = value;
            return this;
        }
